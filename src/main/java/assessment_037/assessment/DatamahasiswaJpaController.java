...
import assessment_037.assessment.exceptions.NonexistentEntityException;
import assessment_037.assessment.exceptions.PreexistingEntityException;
...
public class DatamahasiswaJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("assessment_037_assessment_jar_0.0.1-SNAPSHOTPU");
